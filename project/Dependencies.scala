...
object Dependencies {
  ...
  object SbtPlugin {
    ...
    val fs2gRPC:            ModuleID = "org.lyranthe.fs2-grpc" % "sbt-java-gen"           % "0.4.0-M2"
  ...
  val betterFiles:    ModuleID = "com.github.pathikrit" %% "better-files" % "3.6.0"
