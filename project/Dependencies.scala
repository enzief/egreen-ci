...
object Dependencies {
  ...
  object SbtPlugin {
    ...
    val fs2gRPC: ModuleID            = "org.lyranthe.fs2-grpc" % "sbt-java-gen"           % "0.3.0"
    ...
    val scalafix: ModuleID           = "ch.epfl.scala"         % "sbt-scalafix"           % "0.6.0-M16"
  ...
  object Netty {
    ...
    val version: String = "4.1.27.Final"
